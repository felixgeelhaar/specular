...
type RunManifest struct {
	...
	// AI code generation metadata (when task has codegen hint)
	GeneratedFiles []GeneratedFileRecord `json:"generated_files,omitempty"`
	AIGeneration   *AIGenerationRecord   `json:"ai_generation,omitempty"`
}

// GeneratedFileRecord tracks a file generated by AI
...
// AIGenerationRecord tracks AI usage for audit/billing
