...
**Seed shipped:** `specular policy library list|install` embeds
`soc2-cc8.1`, `iso42001-clause8`, `eu-ai-act-art17`, `nist-ai-rmf-govern4`,
and `pci-dss-6.4.5`. Contribution path: [`policies/library/`](../../policies/library/).
